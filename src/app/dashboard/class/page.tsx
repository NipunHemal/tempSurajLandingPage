    ...
    <>
      ...
      <main className="min-h-screen bg-background pb-12">
        ...
        <div className="relative w-full bg-slate-900 border-b border-border/50 overflow-hidden">
          ...
          <div className="absolute top-1/2 left-10 w-[300px] h-[300px] bg-blue-500/10 rounded-full blur-[80px] pointer-events-none" />
          ...
          <div className="container mx-auto max-w-7xl px-6 py-10 md:py-14 relative z-10 flex flex-col items-center text-center">
            ...
            <div className="w-full max-w-2xl relative group">
              <div className="relative flex items-center bg-white dark:bg-slate-950 rounded-full p-1.5 shadow-lg ring-1 ring-white/10">
                <Search className="ml-4 h-5 w-5 text-slate-400" />
                <Input
                  placeholder="What do you want to learn today?"
                  className="flex-1 border-0 bg-transparent text-base h-11 px-4 placeholder:text-slate-400 focus:outline-none focus:ring-0 focus-visible:ring-0 focus-visible:ring-offset-0 text-slate-900 dark:text-slate-100"
                  value={searchTerm}
